...
\begin{figure}[h!]
	...
	\includegraphics[width=\textwidth]{TITE-DTP-AltWeightWeightFunctions}
\end{figure}
...
Table \ref{tab_tite-dtp:AltWeightW1prob} provides a breakdown of the specific instances where the combined follow-up time is 8 days. We can see in the case where one patient has a follow-up time of 6 days or more the dose recommendation is dose-level 5. As before we also see that these dose decisions match the boundary values we discovered before where all $\beta$ estimates above 0.1493 lead to dose-level 5 and estimates below 0.1492 lead to dose-level 4.  
...
\begin{table}[H]
	...
	\resizebox{\linewidth}{!}{
		...
		\begin{tabular}[t]{cccccc}
			...
			Patient 1 & Patient 2 & Combined & Dose Recommendation & Beta & Variance\\
			\midrule
			\cellcolor{gray!6}{1} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{0.1775} & \cellcolor{gray!6}{1.1845}\\
			2 & 6 & 8 & 5 & 0.1557 & 1.2092\\
			\cellcolor{gray!6}{3} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{0.1415} & \cellcolor{gray!6}{1.2255}\\
			4 & 4 & 8 & 4 & 0.1365 & 1.2311\\
			\bottomrule
	\end{tabular}}
\end{table}
...
\begin{figure}[h!]
	...
	\includegraphics[width=\textwidth]{TITE-DTP-AltWeightW1-Est}
\end{figure}
...
\begin{figure}[h!]
	...
	\includegraphics[width=\textwidth]{TITE-DTP-AltWeightW1-Est789}
\end{figure}
...
\subsection{Weight function 2 in the NN scenario}
