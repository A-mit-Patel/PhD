...
\begin{table}[h!] % OC for order 1 
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}[t]{ccccccccc}
			...
			\rowcolor{gray!6}   & P(select) & 0.63 & 0.18 & 0.05 & 0 & 0 & 0 & 0.13\\
			
			\rowcolor{gray!6}   & \% of patients & 39 & 32 & 20 & 6 & 3 & 0 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 1: MTD @-1} & Mean number of patients & 10.08 & 8.32 & 5.3 & 1.56 & 0.67 & 0.08 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.12 & 0.25 & 0.4 & 0.45 & 0.5 & 0.55 & \\
			
			& P(select) & 0.21 & 0.53 & 0.19 & 0.02 & 0.02 & 0 & 0.03\\
			
			& \% of patients & 18 & 36 & 30 & 11 & 5 & 1 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 2: MTD @0} & Mean number of patients & 5.33 & 10.52 & 8.74 & 3.22 & 1.57 & 0.23 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & 0.25 & 0.4 & 0.45 & 0.5 & \\
			
			\rowcolor{gray!6}   & P(select) & 0.01 & 0.19 & 0.56 & 0.13 & 0.1 & 0.01 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 4 & 20 & 35 & 22 & 16 & 3 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 3: MTD @1} & Mean number of patients & 1.12 & 6.51 & 11.15 & 6.99 & 5.05 & 0.99 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.06 & 0.09 & 0.12 & 0.25 & 0.4 & 0.45 & \\
			
			& P(select) & 0 & 0.02 & 0.23 & 0.47 & 0.24 & 0.04 & 0\\
			
			& \% of patients & 1 & 12 & 20 & 31 & 25 & 10 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 4: MTD @2a} & Mean number of patients & 0.48 & 3.9 & 6.84 & 10.43 & 8.27 & 3.46 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.03 & 0.06 & 0.09 & 0.12 & 0.25 & 0.4 & \\
			
			\rowcolor{gray!6}   & P(select) & 0 & 0 & 0.03 & 0.28 & 0.44 & 0.25 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 1 & 10 & 13 & 25 & 28 & 24 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 5: MTD @2b} & Mean number of patients & 0.25 & 3.37 & 4.29 & 8.24 & 9.36 & 8.14 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.01 & 0.03 & 0.06 & 0.09 & 0.12 & 0.25 & \\
			
			& P(select) & 0 & 0 & 0 & 0.08 & 0.13 & 0.79 & 0\\
			
			& \% of patients & 0 & 10 & 11 & 17 & 18 & 42 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 6: MTD @3} & Mean number of patients & 0.12 & 3.16 & 3.51 & 5.44 & 5.68 & 13.21 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.05 & 0.1 & 0.15 & 0.2 & 0.25 & 0.3 & \\
			
			\rowcolor{gray!6}   & P(select) & 0 & 0.02 & 0.12 & 0.31 & 0.27 & 0.27 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 2 & 13 & 19 & 26 & 22 & 19 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 7: Equal steps in DLT rate} & Mean number of patients & 0.51 & 4.04 & 5.88 & 8.35 & 6.88 & 5.97 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.5 & 0.6 & 0.65 & 0.7 & 0.75 & 0.8 & \\
			
			& P(select) & 0.29 & 0 & 0 & 0 & 0 & 0 & 0.71\\
			
			& \% of patients & 56 & 26 & 15 & 2 & 0 & 0 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 8: All  toxic} & Mean number of patients & 9.05 & 4.2 & 2.42 & 0.32 & 0.03 & 0 & \\
			\bottomrule
	\end{tabular}}
\end{singlespace}
\end{table}
...
\begin{table}[h!] % OC for order 2
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}[t]{ccccccccc}
			...
			\rowcolor{gray!6}   & P(select) & 0.63 & 0.18 & 0.05 & 0 & 0 & 0 & 0.12\\
			
			\rowcolor{gray!6}   & \% of patients & 40 & 32 & 20 & 5 & 2 & 0 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 9: MTD @-1} & Mean number of patients & 10.3 & 8.26 & 5.14 & 1.38 & 0.58 & 0.04 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.12 & 0.25 & 0.4 & 0.5 & 0.45 & 0.55 & \\
			
			& P(select) & 0.22 & 0.52 & 0.21 & 0.02 & 0.02 & 0 & 0.02\\
			
			& \% of patients & 18 & 36 & 29 & 10 & 6 & 1 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 10: MTD @0} & Mean number of patients & 5.28 & 10.67 & 8.76 & 3.1 & 1.73 & 0.2 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & 0.25 & 0.45 & 0.4 & 0.5 & \\
			
			\rowcolor{gray!6}   & P(select) & 0.02 & 0.21 & 0.54 & 0.09 & 0.14 & 0.01 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 4 & 21 & 35 & 20 & 17 & 3 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 11: MTD @1} & Mean number of patients & 1.23 & 6.55 & 11.15 & 6.41 & 5.37 & 1.03 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.06 & 0.09 & 0.12 & 0.25 & 0.15 & 0.45 & \\
			
			& P(select) & 0 & 0.02 & 0.08 & 0.44 & 0.31 & 0.14 & 0\\
			
			& \% of patients & 2 & 12 & 16 & 31 & 22 & 18 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 12: MTD @2a} & Mean number of patients & 0.51 & 3.94 & 5.36 & 10.24 & 7.51 & 5.95 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.03 & 0.06 & 0.09 & 0.35 & 0.25 & 0.4 & \\
			
			\rowcolor{gray!6}   & P(select) & 0 & 0 & 0.15 & 0.31 & 0.43 & 0.11 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 1 & 11 & 19 & 30 & 28 & 13 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 13: MTD @2b} & Mean number of patients & 0.25 & 3.51 & 6.15 & 9.84 & 9.1 & 4.2 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.01 & 0.03 & 0.06 & 0.12 & 0.09 & 0.25 & \\
			
			& P(select) & 0 & 0 & 0 & 0.13 & 0.09 & 0.78 & 0\\
			
			& \% of patients & 0 & 10 & 11 & 19 & 17 & 42 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 14: MTD @3} & Mean number of patients & 0.13 & 3.15 & 3.54 & 5.95 & 5.17 & 13.11 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.05 & 0.1 & 0.15 & 0.25 & 0.2 & 0.3 & \\
			
			\rowcolor{gray!6}   & P(select) & 0 & 0.02 & 0.13 & 0.3 & 0.27 & 0.28 & 0\\
			
			\rowcolor{gray!6}   & \% of patients & 2 & 13 & 19 & 27 & 21 & 19 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 15: Equal steps in DLT rate} & Mean number of patients & 0.52 & 4.09 & 5.89 & 8.48 & 6.64 & 5.91 & \\
			\cmidrule{1-9}
			...
			\multirow{-4}{*}{\centering\arraybackslash 16: All  toxic} & Mean number of patients & 8.66 & 4.15 & 2.23 & 0.27 & 0.04 & 0 & \\
			\bottomrule
	\end{tabular}}
\end{singlespace}
\end{table}
