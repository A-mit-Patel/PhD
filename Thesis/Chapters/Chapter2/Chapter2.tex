	...
	\begin{singlespace}
		\resizebox{\linewidth}{!}{
			\begin{tabular}[t]{ccccccccc}
				...
				\rowcolor{gray!6}   & P(select) & \textbf{0.67} & 0.19 & 0.06 & 0 & 0 & 0 & 0.0825\\
				
				\rowcolor{gray!6}   & \% of patients & \textbf{38} & 32 & 21 & 7 & 3 & 0 & \\
				
				\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 1: TD25 @-1} & Mean number of patients & \textbf{10.05} & 8.38 & 5.48 & 1.8 & 0.78 & 0.09 & \\
				\cmidrule{1-9}
				& True DLT rate & 0.12 & \textbf{0.25} & 0.4 & 0.45 & 0.5 & 0.55 & \\
				
				& P(select) & 0.22 & \textbf{0.52} & 0.2 & 0.02 & 0.02 & 0 & 0.0105\\
				
				& \% of patients & 17 & \textbf{35} & 29 & 11 & 6 & 1 & \\
				
				\multirow{-4}{*}{\centering\arraybackslash 2: TD25 @0} & Mean number of patients & 5.16 & \textbf{10.55} & 8.79 & 3.36 & 1.88 & 0.24 & \\
				\cmidrule{1-9}
				\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & \textbf{0.25} & 0.4 & 0.45 & 0.5 & \\
				
				\rowcolor{gray!6}   & P(select) & 0.02 & 0.2 & \textbf{0.55} & 0.14 & 0.1 & 0 & 5e-04\\
	...
	\begin{singlespace}
		\resizebox{\linewidth}{!}{
			\begin{tabular}[t]{ccccccccc}
				...
				\rowcolor{gray!6}   & P(select) & \textbf{0.67} & 0.19 & 0.04 & 0 & 0.01 & 0 & 0.0865\\
				
				\rowcolor{gray!6}   & \% of patients & \textbf{39} & 32 & 20 & 6 & 3 & 0 & \\
				
				\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 9: TD25 @-1} & Mean number of patients & \textbf{10.22} & 8.25 & 5.15 & 1.62 & 0.72 & 0.04 & \\
				\cmidrule{1-9}
				& True DLT rate & 0.12 & \textbf{0.25} & 0.4 & 0.5 & 0.45 & 0.55 & \\
				
				& P(select) & 0.22 & \textbf{0.53} & 0.19 & 0.02 & 0.03 & 0 & 0.0065\\
				
				& \% of patients & 18 & \textbf{35} & 29 & 11 & 6 & 1 & \\
				
				\multirow{-4}{*}{\centering\arraybackslash 10: TD25 @0} & Mean number of patients & 5.25 & \textbf{10.49} & 8.73 & 3.32 & 1.84 & 0.3 & \\
				\cmidrule{1-9}
				\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & \textbf{0.25} & 0.45 & 0.4 & 0.5 & \\
				
				\rowcolor{gray!6}   & P(select) & 0.02 & 0.2 & \textbf{0.54} & 0.09 & 0.15 & 0.01 & 0\\
...
\begin{enumerate}
	...
	\item No follow-up (No FU). This design uses a cohort size of 1 and removes the minimum follow-up period. All other stopping rules remain the same. \textbf{Simulation results for this design are incorrect. Please ignore this data in the table for now.}
\end{enumerate} 

\begin{table} % Table for alterative designs
	...
	\begin{singlespace}
		\resizebox{\linewidth}{!}{
			...
			\begin{tabular}[t]{ccccccccccc}
				...
				\rowcolor{gray!6}   & PO-TITE & P(select) & 0.67 & 0.19 & 0.06 & 0 & 0 & 0 & 0.08 & 57.95\\
				
				\rowcolor{gray!6}   & TITE & P(select) & 0.71 & 0.21 & 0.05 & 0 & 0 & 0 & 0.03 & 59.84\\
				
				\rowcolor{gray!6}   & PO & P(select) & 0.57 & 0.18 & 0.04 & 0.01 & 0 & 0 & 0.2 & 131.02\\
				
				\rowcolor{gray!6}   & N = 30 & P(select) & 0.65 & 0.21 & 0.05 & 0.01 & 0 & 0 & 0.08 & 60.27\\
				
				\rowcolor{gray!6}   & N = 60 & P(select) & 0.79 & 0.12 & 0.01 & 0 & 0 & 0 & 0.08 & 107.48\\
				
				\rowcolor{gray!6}  \multirow{-7}{*}{\centering\arraybackslash 1: TD25 @-1} & No cohorts & P(select) & 0.63 & 0.16 & 0.04 & 0.01 & 0.01 & 0 & 0.15 & 86.77\\
				\cmidrule{1-11}
				&  & True DLT rate & 0.12 & 0.25 & 0.4 & 0.45 & 0.5 & 0.55 &  & \\
				
				& PO-TITE & P(select) & 0.22 & 0.52 & 0.2 & 0.02 & 0.02 & 0 & 0.01 & 64.08\\
				
				& TITE & P(select) & 0.22 & 0.53 & 0.21 & 0.04 & 0 & 0 &  & 63.29\\
				
				& PO & P(select) & 0.21 & 0.53 & 0.2 & 0.02 & 0.01 & 0 & 0.02 & 163.6\\
				
				& N = 30 & P(select) & 0.22 & 0.5 & 0.21 & 0.04 & 0.02 & 0 & 0.01 & 63.16\\
				
				& N = 60 & P(select) & 0.15 & 0.69 & 0.14 & 0.01 & 0 & 0 & 0.01 & 115.96\\
				
				\multirow{-7}{*}{\centering\arraybackslash 2: TD25 @0} & No cohorts & P(select) & 0.26 & 0.45 & 0.2 & 0.03 & 0.02 & 0.01 & 0.04 & 104.49\\
				\cmidrule{1-11}
				\rowcolor{gray!6}   &  & True DLT rate & 0.09 & 0.12 & 0.25 & 0.4 & 0.45 & 0.5 &  & \\
				
				\rowcolor{gray!6}   & PO-TITE & P(select) & 0.02 & 0.2 & 0.55 & 0.14 & 0.1 & 0 &  & 67.37\\
				
				\rowcolor{gray!6}   & TITE & P(select) & 0.01 & 0.19 & 0.56 & 0.2 & 0.03 & 0.01 &  & 64.17\\
				
				\rowcolor{gray!6}   & PO & P(select) & 0.02 & 0.16 & 0.59 & 0.14 & 0.08 & 0.01 &  & 179.11\\
				
				\rowcolor{gray!6}   & N = 30 & P(select) & 0.02 & 0.17 & 0.53 & 0.15 & 0.13 & 0.01 &  & 64\\
				
				\rowcolor{gray!6}   & N = 60 & P(select) & 0 & 0.14 & 0.7 & 0.1 & 0.06 & 0 &  & 117.75\\
				
				\rowcolor{gray!6}  \multirow{-7}{*}{\centering\arraybackslash 3: TD25 @1} & No cohorts & P(select) & 0.05 & 0.18 & 0.49 & 0.14 & 0.09 & 0.02 & 0.01 & 113.69\\
				\cmidrule{1-11}
				&  & True DLT rate & 0.06 & 0.09 & 0.12 & 0.25 & 0.4 & 0.45 &  & \\
				
				& PO-TITE & P(select) & 0 & 0.02 & 0.22 & 0.48 & 0.23 & 0.05 &  & 70\\
				
				& TITE & P(select) & 0 & 0.02 & 0.22 & 0.56 & 0.18 & 0.03 &  & 67.16\\
				
				& PO & P(select) & 0 & 0.02 & 0.21 & 0.49 & 0.22 & 0.05 &  & 190.17\\
				
				& N = 30 & P(select) & 0 & 0.02 & 0.21 & 0.45 & 0.28 & 0.04 &  & 64.08\\
				
				& N = 60 & P(select) & 0 & 0 & 0.18 & 0.62 & 0.19 & 0.01 &  & 117.99\\
				
				\multirow{-7}{*}{\centering\arraybackslash 4: TD25 @2a} & No cohorts & P(select) & 0.02 & 0.02 & 0.21 & 0.46 & 0.2 & 0.09 &  & 114.11\\
				\cmidrule{1-11}
				\rowcolor{gray!6}   &  & True DLT rate & 0.03 & 0.06 & 0.09 & 0.12 & 0.25 & 0.4 &  & \\
				
				\rowcolor{gray!6}   & PO-TITE & P(select) & 0 & 0 & 0.02 & 0.31 & 0.42 & 0.24 &  & 70.78\\
				
				\rowcolor{gray!6}   & TITE & P(select) & 0 & 0 & 0.02 & 0.22 & 0.58 & 0.18 &  & 68.35\\
				
				\rowcolor{gray!6}   & PO & P(select) & 0 & 0 & 0.03 & 0.25 & 0.44 & 0.28 &  & 195.1\\
				
				\rowcolor{gray!6}   & N = 30 & P(select) & 0 & 0 & 0.03 & 0.31 & 0.41 & 0.25 &  & 64.12\\
				
				\rowcolor{gray!6}   & N = 60 & P(select) & 0 & 0 & 0 & 0.24 & 0.62 & 0.14 &  & 118.09\\
				
				\rowcolor{gray!6}  \multirow{-7}{*}{\centering\arraybackslash 5: TD25 @2b} & No cohorts & P(select) & 0.01 & 0 & 0.02 & 0.25 & 0.41 & 0.3 &  & 110.25\\
				\cmidrule{1-11}
				&  & True DLT rate & 0.01 & 0.03 & 0.06 & 0.09 & 0.12 & 0.25 &  & \\
				
				& PO-TITE & P(select) & 0 & 0 & 0 & 0.1 & 0.13 & 0.77 &  & 65.72\\
				
				& TITE & P(select) & 0 & 0 & 0 & 0.03 & 0.24 & 0.74 &  & 65.77\\
				
				& PO & P(select) & 0 & 0 & 0 & 0.08 & 0.12 & 0.8 &  & 183.46\\
				
				& N = 30 & P(select) & 0 & 0 & 0 & 0.1 & 0.13 & 0.77 &  & 64.12\\
				
				& N = 60 & P(select) & 0 & 0 & 0 & 0.06 & 0.1 & 0.85 &  & 118.09\\
				
				\multirow{-7}{*}{\centering\arraybackslash 6: TD25 @3} & No cohorts & P(select) & 0 & 0 & 0 & 0.06 & 0.1 & 0.83 &  & 93.36\\
				\cmidrule{1-11}
				\rowcolor{gray!6}   &  & True DLT rate & 0.05 & 0.1 & 0.15 & 0.2 & 0.25 & 0.3 &  & \\
				
				\rowcolor{gray!6}   & PO-TITE & P(select) & 0 & 0.03 & 0.11 & 0.3 & 0.29 & 0.27 &  & 67.49\\
				
				\rowcolor{gray!6}   & TITE & P(select) & 0 & 0.03 & 0.14 & 0.32 & 0.29 & 0.21 &  & 64.54\\
				
				\rowcolor{gray!6}   & PO & P(select) & 0 & 0.03 & 0.15 & 0.3 & 0.26 & 0.26 &  & 185.84\\
				
				\rowcolor{gray!6}   & N = 30 & P(select) & 0 & 0.01 & 0.12 & 0.29 & 0.32 & 0.25 &  & 64.08\\
				
				\rowcolor{gray!6}   & N = 60 & P(select) & 0 & 0 & 0.08 & 0.33 & 0.34 & 0.25 &  & 117.94\\
				
				\rowcolor{gray!6}  \multirow{-7}{*}{\centering\arraybackslash 7: Equal steps} & No cohorts & P(select) & 0.03 & 0.02 & 0.09 & 0.24 & 0.24 & 0.37 &  & 102.15\\
				\cmidrule{1-11}
				&  & True DLT rate & 0.5 & 0.6 & 0.65 & 0.7 & 0.75 & 0.8 &  & \\
				
				& PO-TITE & P(select) & 0.26 & 0 & 0 & 0 & 0 & 0 & 0.73 & 39.01\\
				
				& TITE & P(select) & 0.37 & 0 & 0 & 0 & 0 & 0 & 0.63 & 44.67\\
				
				& PO & P(select) & 0.14 & 0 & 0 & 0 & 0 & 0 & 0.86 & 70.42\\
				
				& N = 30 & P(select) & 0.24 & 0 & 0 & 0 & 0 & 0 & 0.76 & 41.73\\
				
				& N = 60 & P(select) & 0.14 & 0 & 0 & 0 & 0 & 0 & 0.86 & 48.2\\
				
				\multirow{-7}{*}{\centering\arraybackslash 8: All toxic} & No cohorts & P(select) & 0.33 & 0 & 0 & 0 & 0 & 0 & 0.67 & 47.54\\
				\bottomrule
		\end{tabular}}
	\end{singlespace}
\end{table}
