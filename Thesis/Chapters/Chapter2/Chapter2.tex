...
\begin{table}[H] % OC for order 1 
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}[t]{ccccccccc}
			...
			\rowcolor{gray!6}   & P(select) & \textbf{0.62} & 0.19 & 0.05 & 0 & 0 & 0 & 0.12\\
			
			\rowcolor{gray!6}   & \% of patients & \textbf{39} & 32 & 21 & 6 & 2 & 0 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 1: TD25 @-1} & Mean number of patients & \textbf{10.09} & 8.2 & 5.29 & 1.48 & 0.61 & 0.07 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.12 & \textbf{0.25} & 0.4 & 0.45 & 0.5 & 0.55 & \\
			
			& P(select) & 0.21 & \textbf{0.51} & 0.21 & 0.03 & 0.02 & 0 & 0.02\\
			
			& \% of patients & 18 & \textbf{36} & 30 & 10 & 5 & 0 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 2: TD25 @0} & Mean number of patients & 5.46 & \textbf{10.66} & 8.77 & 3.01 & 1.49 & 0.15 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & \textbf{0.25} & 0.4 & 0.45 & 0.5 & \\
			
			\rowcolor{gray!6}   & P(select) & 0.02 & 0.2 & \textbf{0.55} & 0.13 & 0.09 & 0.01 & 0\\
...
\begin{table}[H] % OC for order 2
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}[t]{ccccccccc}
			...
			\rowcolor{gray!6}   & P(select) & \textbf{0.63} & 0.18 & 0.04 & 0 & 0 & 0 & 0.14\\
			
			\rowcolor{gray!6}   & \% of patients & \textbf{41} & 32 & 20 & 5 & 2 & 0 & \\
			
			\rowcolor{gray!6}  \multirow{-4}{*}{\centering\arraybackslash 9: TD25 @-1} & Mean number of patients & \textbf{10.4} & 8.23 & 5.07 & 1.28 & 0.46 & 0.04 & \\
			\cmidrule{1-9}
			& True DLT rate & 0.12 & \textbf{0.25} & 0.4 & 0.5 & 0.45 & 0.55 & \\
			
			& P(select) & 0.21 & \textbf{0.51} & 0.21 & 0.01 & 0.02 & 0 & 0.02\\
			
			& \% of patients & 18 & \textbf{36} & 30 & 10 & 6 & 1 & \\
			
			\multirow{-4}{*}{\centering\arraybackslash 10: TD25 @0} & Mean number of patients & 5.42 & \textbf{10.61} & 8.83 & 2.83 & 1.74 & 0.18 & \\
			\cmidrule{1-9}
			\rowcolor{gray!6}   & True DLT rate & 0.09 & 0.12 & \textbf{0.25} & 0.45 & 0.4 & 0.5 & \\
			
			\rowcolor{gray!6}   & P(select) & 0.02 & 0.20 & \textbf{0.53} & 0.10 & 0.14 & 0.01 & 0\\
