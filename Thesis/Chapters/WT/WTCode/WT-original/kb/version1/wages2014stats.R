...
source('wagestait/kb/version1/wagestait.R')
...
write(toJSON(res.t1.r1, pretty = T, auto_unbox = T), file = paste0(out.dir, "V1.T1.R1.json"))

res.t1.r2 = bpocrm.sim(t1, r2, p.skel, q.skel, tul, ell, cohortsize, ncohort, 1000)
write(toJSON(res.t1.r2, pretty = T, auto_unbox = T), file = paste0(out.dir, "V1.T1.R2.json"))

res.t1.r3 = bpocrm.sim(t1, r3, p.skel, q.skel, tul, ell, cohortsize, ncohort, 1000)
write(toJSON(res.t1.r3, pretty = T, auto_unbox = T), file = paste0(out.dir, "V1.T1.R3.json"))





# TODO - have not ventured below here yet. KB. 14-Mar-2013
