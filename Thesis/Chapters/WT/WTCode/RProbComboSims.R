...
s2tox <- c(0.01, 0.45, 0.55, 0.65, 0.75)
...
s4tox <- c(0.01, 0.45, 0.55, 0.65, 0.75)
...
s6tox <- c(0.01, 0.45, 0.55, 0.65, 0.75)
...
s12tox <- c(0.01, 0.45, 0.55, 0.65, 0.75)
###############################################################################
###############################################################################
...
# Scenario 9 
set.seed(seed); n60p20sims8 = wt.sim(s9tox, s9eff, p.skel, q.skel, tul, ell,
                                     cohortsize, ncohort, start.comb, n.ar=n.ar, 
                                     ntrial = ntrial, safety.conf = safety.conf, 
                                     futility.conf = futility.conf,
                                     check.tox.at.dose.level = 2,
...
set.seed(seed); n60p33sims8 = wt.sim(s8tox, s8eff, p.skel, q.skel, tul, ell,
                                     ...
                                     placebo.rand.prob = placebo.rand.prob)
# Scenario 9 
set.seed(seed); n60p33sims8 = wt.sim(s9tox, s9eff, p.skel, q.skel, tul, ell,
                                     cohortsize, ncohort, start.comb, n.ar=n.ar, 
                                     ntrial = ntrial, safety.conf = safety.conf, 
                                     futility.conf = futility.conf,
                                     check.tox.at.dose.level = 2,
