...
\chapter{Extension to a Phase I/II trial design} % Main chapter title
...
Here we will briefly explore some of these designs. This is not an extensive review of the literature but just an illustration of these types of trial design. 
...
For the control dose, we have set our prior beliefs for the probability of toxicity at 10\% and the probability of efficacy at 30\%. These values can be altered if there is reason to believe that the control dose may have higher or lower probabilities of toxicity and efficacy. 
...
\begin{table}[h!]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}[t]{ccccccccccccccccccccc}
			\toprule
			\multicolumn{2}{c}{ } & \multicolumn{15}{c}{Selection probabilities: Scenarios 1-15} & \multicolumn{2}{c}{All scenarios} & \multicolumn{2}{c}{Non Stopping} \\
...
\begin{table}
	...
	\caption{\label{tab_WT:EstimatesExampleRunAR}Summary of model outputs during the adaptive randomisation phase for our example trial run.}
	\resizebox{\linewidth}{!}{
		\begin{tabular}{ccccccccccc}
			\toprule
			\multicolumn{4}{c}{ } & \multicolumn{5}{c}{Estimated probabilities} & \multicolumn{2}{c}{ } \\
			\cmidrule(l{3pt}r{3pt}){5-9}
			Cohort & Dose & Outcome &   & 1 & 2 & 3 & 4 & 5 & Recommended & Optimal\\
			\midrule
			&  &  & tox & 0.06 & 0.09 & 0.14 & 0.19 & 0.26 &  & \\
			
			&  &  & eff & 0.34 & 0.68 & 0.59 & 0.5 & 0.42 &  & \\
			
			\multirow{-3}{*}{\centering\arraybackslash 1} & \multirow{-3}{*}{\centering\arraybackslash 2} & \multirow{-3}{*}{\centering\arraybackslash EEN} & rand. & 0.33 & 0.21 & 0.18 & 0.15 & 0.13 & \multirow{-3}{*}{\centering\arraybackslash 3} & \multirow{-3}{*}{\centering\arraybackslash 2}\\
			\cmidrule{1-11}
			&  &  & tox & 0.02 & 0.04 & 0.07 & 0.11 & 0.17 &  & \\
			
			&  &  & eff & 0.51 & 0.74 & 0.8 & 0.74 & 0.67 &  & \\
			
			\multirow{-3}{*}{\centering\arraybackslash 2} & \multirow{-3}{*}{\centering\arraybackslash 3} & \multirow{-3}{*}{\centering\arraybackslash EEE} & rand. & 0.33 & 0.17 & 0.18 & 0.17 & 0.15 & \multirow{-3}{*}{\centering\arraybackslash 3} & \multirow{-3}{*}{\centering\arraybackslash 3}\\
			\cmidrule{1-11}
			&  &  & tox & 0.02 & 0.04 & 0.07 & 0.11 & 0.17 &  & \\
			
			&  &  & eff & 0.51 & 0.74 & 0.8 & 0.74 & 0.67 &  & \\
			
			\multirow{-3}{*}{\centering\arraybackslash 3} & \multirow{-3}{*}{\centering\arraybackslash 3} & \multirow{-3}{*}{\centering\arraybackslash EEE} & rand. & 0.33 & 0.17 & 0.18 & 0.17 & 0.15 & \multirow{-3}{*}{\centering\arraybackslash 4} & \multirow{-3}{*}{\centering\arraybackslash 3}\\
			\cmidrule{1-11}
...
As 10 cohorts of three patients have now been recruited we have reached the 30 patient limit for the AR phase. Moving into the maximisation phase doses are no longer randomly allocated and instead the optimal dose is now the dose that is recommended. From cohort 10 in Table \ref{tab_WT:EstimatesExampleRunAR} we can see the optimal dose is dose-level 3 and there would be the dose recommended for cohort 11. Table \ref{tab_WT:EstimatesExampleRunMax} provides a summary of the model outputs for the next 10 cohorts based on specific outcomes. Thee adaptive randomisation probabilities are no longer presented as they are not required to allocate patients and as the optimal dose is now always the recommended dose these can be considered the same. 
 ...
 \begin{table}
 	\centering\begingroup\fontsize{9}{11}\selectfont
 	\caption{\label{tab_WT:EstimatesExampleRunMax}Summary of model outputs during the maximisation phase for our example trial run.}
 	\resizebox{\linewidth}{!}{
 		\begin{tabular}{cccccccccc}
 			\toprule
 			\multicolumn{4}{c}{ } & \multicolumn{5}{c}{Estimated probabilities} & \multicolumn{1}{c}{ } \\
 			\cmidrule(l{3pt}r{3pt}){5-9}
 			Cohort & Dose & Outcome &   & 1 & 2 & 3 & 4 & 5 & Recommended/Optimal\\
 			\midrule
 			&  &  & tox & 0.02 & 0.04 & 0.09 & 0.15 & 0.24 & \\
 			
 			\multirow{-2}{*}{\centering\arraybackslash 11} & \multirow{-2}{*}{\centering\arraybackslash 3} & \multirow{-2}{*}{\centering\arraybackslash EEN} & eff & 0.25 & 0.55 & 0.65 & 0.55 & 0.44 & \multirow{-2}{*}{\centering\arraybackslash 3}\\
 			\cmidrule{1-10}
 			&  &  & tox & 0.04 & 0.07 & 0.14 & 0.23 & 0.32 & \\
 			
 			\multirow{-2}{*}{\centering\arraybackslash 12} & \multirow{-2}{*}{\centering\arraybackslash 3} & \multirow{-2}{*}{\centering\arraybackslash BBE} & eff & 0.28 & 0.57 & 0.68 & 0.57 & 0.47 & \multirow{-2}{*}{\centering\arraybackslash 3}\\
 			\cmidrule{1-10}
 			&  &  & tox & 0.05 & 0.08 & 0.16 & 0.25 & 0.34 & \\
 			
 			\multirow{-2}{*}{\centering\arraybackslash 13} & \multirow{-2}{*}{\centering\arraybackslash 3} & \multirow{-2}{*}{\centering\arraybackslash BEE} & eff & 0.3 & 0.59 & 0.69 & 0.59 & 0.49 & \multirow{-2}{*}{\centering\arraybackslash 3}\\
 			\cmidrule{1-10}
 			&  &  & tox & 0.06 & 0.09 & 0.17 & 0.26 & 0.36 & \\
 			
 			\multirow{-2}{*}{\centering\arraybackslash 14} & \multirow{-2}{*}{\centering\arraybackslash 3} & \multirow{-2}{*}{\centering\arraybackslash EET} & eff & 0.3 & 0.59 & 0.69 & 0.59 & 0.49 & \multirow{-2}{*}{\centering\arraybackslash 3}\\
 			\cmidrule{1-10}
 			&  &  & tox & 0.06 & 0.1 & 0.18 & 0.28 & 0.37 & \\
 			
 			\multirow{-2}{*}{\centering\arraybackslash 15} & \multirow{-2}{*}{\centering\arraybackslash 3} & \multirow{-2}{*}{\centering\arraybackslash ENT} & eff & 0.27 & 0.57 & 0.67 & 0.57 & 0.47 & \multirow{-2}{*}{\centering\arraybackslash 3}\\
 			\cmidrule{1-10}
 			&  &  & tox & 0.07 & 0.11 & 0.19 & 0.29 & 0.39 & \\
...
\begin{table}[h!]
	...
	\caption{\label{tab_wt:OCsDesigns-to-compare-Summary} Selection probabilities and summary statistics for multiple designs.}
	\centering
	\resizebox{\linewidth}{!}{
