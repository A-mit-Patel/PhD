...
Finally, scenarios 10 and 12 look at the versions of scenarios 9 and 11 respectively where all doses are toxic. Once again, similar characteristics are observed in other toxic scenarios. 
...
\begin{table}
	...
	\caption[Mean No. of patients for alternative trial designs.]{\label{tab_wt:MeanNAlt}Mean number of patients allocated to each dose-level for alternative trial designs.}
	\centering
	\resizebox{\linewidth}{!}{
		\fontsize{12}{14}\selectfont
		\begin{tabular}[t]{ccccccc>{}c|cccccccc}
...
\begin{table}
	...
	\caption[Selection probabilities for an active control dose.]{\label{tab_wt:SelectProbEffSkel}Selection probabilities for an active control with different sets of efficacy skeletons.}
	\centering
	\resizebox{\linewidth}{!}{
		\fontsize{12}{14}\selectfont
		\begin{tabular}[t]{ccccccc>{}c|cccccccc}
			\toprule
			Scenario & Set & Dose 1 & Dose 2 & Dose 3 & Dose 4 & Dose 5 & Stop & Scenario & Set & Dose 1 & Dose 2 & Dose 3 & Dose 4 & Dose 5 & Stop\\
			\midrule
			P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 &  & P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 \vphantom{2} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.25 & 0.35 & 0.45 & 0.55 &  & P(eff) &  & 0.05 & 0.25 & 0.35 & 0.55 & 0.55 \vphantom{1} & \\
			\cmidrule{1-16}
			& A & 0 & 0.14 & 0.25 & 0.38 & 0.23 & 0 &  & A & 0 & 0.1 & 0.16 & 0.55 & 0.19 & 0\\
			
			\multirow{-2}{*}{\centering\arraybackslash 1} & B & 0 & 0.07 & 0.18 & 0.45 & 0.29 & 0 & \multirow{-2}{*}{\centering\arraybackslash 7} & B & 0 & 0.05 & 0.09 & 0.58 & 0.28 & 0\\
			\cmidrule{1-16}
			P(tox) &  & 0.05 & 0.5 & 0.55 & 0.65 & 0.75 &  & P(tox) &  & 0.05 & 0.5 & 0.55 & 0.65 & 0.75 \vphantom{2} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.25 & 0.35 & 0.45 & 0.55 &  & P(eff) &  & 0.05 & 0.25 & 0.35 & 0.55 & 0.55 & \\
			\cmidrule{1-16}
			& A & 0.07 & 0.24 & 0 & 0 & 0 & 0.68 &  & A & 0.07 & 0.24 & 0 & 0 & 0 & 0.68\\
			
			\multirow{-2}{*}{\centering\arraybackslash 2} & B & 0.07 & 0.26 & 0 & 0 & 0 & 0.67 & \multirow{-2}{*}{\centering\arraybackslash 8} & B & 0.07 & 0.25 & 0 & 0 & 0 & 0.67\\
			\cmidrule{1-16}
			P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 &  & P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 \vphantom{1} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.03 & 0.06 & 0.09 & 0.12 &  & P(eff) &  & 0.05 & 0.35 & 0.55 & 0.35 & 0.25 & \\
			\cmidrule{1-16}
			& A & 0 & 0.1 & 0.17 & 0.32 & 0.36 & 0.05 &  & A & 0 & 0.2 & 0.74 & 0.06 & 0.01 & 0\\
...
\begin{table}
	...
	\caption[Mean No. of patients for an active control dose.]{\label{tab_wt:MeanNEffSkel}Mean number of patients allocated to each dose-level for for an active control with different sets of efficacy skeletons.}
	\centering
	\resizebox{\linewidth}{!}{
		\fontsize{12}{14}\selectfont
		\begin{tabular}[t]{ccccccc>{}c|cccccccc}
			\toprule
			Scenario & Set & Dose 1 & Dose 2 & Dose 3 & Dose 4 & Dose 5 & Total & Scenario & Set & Dose 1 & Dose 2 & Dose 3 & Dose 4 & Dose 5 & Total\\
			\midrule
			P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 &  & P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 \vphantom{2} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.25 & 0.35 & 0.45 & 0.55 &  & P(eff) &  & 0.05 & 0.25 & 0.35 & 0.55 & 0.55 \vphantom{1} & \\
			\cmidrule{1-16}
			& A & 8.5 & 14.1 & 15 & 14.5 & 7.9 & 60 &  & A & 8.5 & 13.3 & 13.8 & 16.8 & 7.5 & 59.9\\
			
			\multirow{-2}{*}{\centering\arraybackslash 1} & B & 8.6 & 12.3 & 13.9 & 16 & 9.2 & 60 & \multirow{-2}{*}{\centering\arraybackslash 7} & B & 8.5 & 11.9 & 12.5 & 17.8 & 9.3 & 60\\
			\cmidrule{1-16}
			P(tox) &  & 0.05 & 0.5 & 0.55 & 0.65 & 0.75 &  & P(tox) &  & 0.05 & 0.5 & 0.55 & 0.65 & 0.75 \vphantom{2} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.25 & 0.35 & 0.45 & 0.55 &  & P(eff) &  & 0.05 & 0.25 & 0.35 & 0.55 & 0.55 & \\
			\cmidrule{1-16}
			& A & 14.2 & 24.3 & 1.4 & 0.1 & 0 & 40 &  & A & 14.2 & 24.2 & 1.3 & 0.1 & 0 & 39.8\\
			
			\multirow{-2}{*}{\centering\arraybackslash 2} & B & 14.4 & 24.4 & 1.5 & 0.1 & 0 & 40.4 & \multirow{-2}{*}{\centering\arraybackslash 8} & B & 14.4 & 24.3 & 1.4 & 0.1 & 0 & 40.2\\
			\cmidrule{1-16}
			P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 &  & P(tox) &  & 0.05 & 0.05 & 0.1 & 0.2 & 0.25 \vphantom{1} & \\
			\cmidrule{1-16}
			P(eff) &  & 0.05 & 0.03 & 0.06 & 0.09 & 0.12 &  & P(eff) &  & 0.05 & 0.35 & 0.55 & 0.35 & 0.25 & \\
			\cmidrule{1-16}
			& A & 8.5 & 11 & 13.4 & 15.1 & 11.7 & 59.7 &  & A & 8.5 & 16.5 & 22.1 & 9.4 & 3.5 & 60\\
