...
code <-kable(OC_tab, "latex", booktabs = T, linesep = "", align = "c", 
            caption = " Operating Characteristics of the two-stage PO TITE-CRM (using true DLT rates which imply dose level 2b is more toxic than 2a) in eight different scenarios based on 10000 simulated trials of 60 patients in cohorts of three. Definitions: DLT: Dose-limiting toxicity. P(select):
...
code2 <-kable(OC_tab2, "latex", booktabs = T, linesep = "", align = "c", 
            caption = " Operating Characteristics of the two-stage PO TITE-CRM (using true DLT rates which imply dose level 2a is more toxic than 2b) in eight different scenarios based on 1000 simulated trials of 60 patients in cohorts of three. Definitions: DLT: Dose-limiting toxicity. P(select):
Probability of selecting a dose as the MTD.") %>%
        kable_styling(latex_options = c("striped", "HOLD_position"),
                      position = "center",
                      stripe_index = c(2:5, 10:13, 18:21, 26:29)) %>% 
