...
mtd.lim <- 15
# The number of patients recruited per observation window
recrate <- 3.94 # Roughly 1 patient every 105 days (min fu)
# ie new patient enters once last has reached min fu. 


r <- c(0.25, 0.40, 0.45, 0.50, 0.55, 0.60)
set.seed(101)
modco_s1 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                              tox.range, cohort, obswin, minfu, win2, recrate,
                                mtd.lim, tox.lim, tox.cert)
modco_s1
...
r <- c(0.12 ,0.25, 0.40, 0.45, 0.50, 0.55)
set.seed(102)
modco_s2 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                          tox.range, cohort, obswin, minfu, win2, recrate,
                          mtd.lim, tox.lim, tox.cert)
modco_s2
...
r <- c(0.09 ,0.12 ,0.25, 0.40, 0.45, 0.50)
set.seed(103)
modco_s3 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                          tox.range, cohort, obswin, minfu, win2, recrate,
                          mtd.lim, tox.lim, tox.cert)
modco_s3
...
r <- c(0.06, 0.09, 0.12, 0.25, 0.40, 0.45)
set.seed(104)
modco_s4 <-titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                         tox.range, cohort, obswin, minfu, win2, recrate,                                
                         mtd.lim, tox.lim, tox.cert)
modco_s4
...
r <- c(0.03, 0.06, 0.09, 0.12 ,0.25, 0.40)
set.seed(105)
modco_s5 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                          tox.range, cohort, obswin, minfu, win2, recrate,
                          mtd.lim, tox.lim, tox.cert)
modco_s5
...
r <- c(0.01, 0.03, 0.06, 0.09, 0.12 ,0.25)
set.seed(106)
modco_s6 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                          tox.range, cohort, obswin, minfu, win2, recrate,
                          mtd.lim, tox.lim, tox.cert)
modco_s6
...
r <- c(0.05, 0.10, 0.15, 0.20 ,0.25 ,0.30)
set.seed(107)
modco_s7 <- titepocrm_sim(r, alpha, prior.o, x0, stop, n, theta, nsim, 
                          tox.range, cohort, obswin, minfu, win2, recrate,
                          mtd.lim, tox.lim, tox.cert)
modco_s7
