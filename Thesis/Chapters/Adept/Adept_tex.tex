...
\label{Adept} % For referencing this chapter elsewhere, use \ref{Chapter2}
	...
	\begin{singlespace}
		\resizebox{\linewidth}{!}{
			...
			\begin{tabular}[t]{cccccccccccc}
				...
				\rowcolor{gray!6}   & PO-TITE & P(select) & 0.67 & 0.19 & 0.06 & 0 & 0 & 0 & 0.08 & 57.95 & 26.57\\
				
				\rowcolor{gray!6}   & TITE & P(select) & 0.71 & 0.21 & 0.05 & 0 & 0 & 0 & 0.03 & 59.84 & 27.62\\
				
				\rowcolor{gray!6}   & PO & P(select) & 0.57 & 0.18 & 0.04 & 0.01 & 0 & 0 & 0.2 & 131.02 & 21.9\\
				
				\rowcolor{gray!6}   & N = 30 & P(select) & 0.65 & 0.21 & 0.05 & 0.01 & 0 & 0 & 0.08 & 60.27 & 27.86\\
				
				\rowcolor{gray!6}   & N = 60 & P(select) & 0.79 & 0.12 & 0.01 & 0 & 0 & 0 & 0.08 & 107.48 & 54.1\\
				
				\rowcolor{gray!6}  \multirow{-7}{*}{\centering\arraybackslash 1: TD25 @-1} & No cohorts & P(select) & 0.63 & 0.16 & 0.04 & 0.01 & 0.01 & 0 & 0.15 & 86.77 & 22.19\\
				\cmidrule{1-12}
