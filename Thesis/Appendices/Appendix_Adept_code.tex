...
\lstinputlisting[breaklines=true, firstline=10, lastline=140]{Chapters/Adept/ADePT/tite.pocrm.r}

The code below is for various functions that were used to run the simulations in Chapter \ref{Adept}. 

\lstinputlisting[breaklines=true]{Chapters/Adept/ADePT/Functions.r}
...
\lstinputlisting[breaklines=true, firstline=24, lastline=491]{Chapters/WT/WTCode/RtC-WT.r}

\section{TITE-DTP chapter code}

The code below was used to generate the DTPs used as examples in Chapter \ref{TITE-DTP}. 

\lstinputlisting[breaklines=true]{Chapters/TITE-DTP/TITE-DTP/ExampleDTPs.r}

The code below was used to generate the TITE-DTPs in Chapter \ref{TITE-DTP}.

\lstinputlisting[breaklines=true]{Chapters/TITE-DTP/TITE-DTP/TITE-DTPsExamples.r}

\section{ETP chapter code}

The code below was used to run the simulations shown in Chapter \ref{etp}.

\lstinputlisting[breaklines=true, firstline=1, lastline=70]{Chapters/ETP/ETP/BetaBinomialSims.r}


The function below was created to produce ETPs. 

\lstinputlisting[breaklines=true, firstline=25, lastline=283]{Chapters/ETP/ETP/f_etp.r}